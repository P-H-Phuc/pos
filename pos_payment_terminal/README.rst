...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fpos-lightgray.png?logo=github
    :target: https://github.com/OCA/pos/tree/18.0/pos_payment_terminal
    :alt: OCA/pos
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.odoo-community.org/projects/pos-18-0/pos-18-0-pos_payment_terminal
...
project <https://github.com/akretion/pywebdriver>`__ as an alternative
to the POSbox/IoTbox.
...
- Go to *Point of Sale > Configuration > Payment Methods*, edit the
  ...
  a payment terminal* to *OCA Payment Terminal*. A new field *Payment
  Mode* will appear, that has *Card* as defaut value. If the payment
  method is for Checks and you have a check printer, select *Check*
  instead.

|image1|

.. |image1| image:: https://raw.githubusercontent.com/OCA/pos/18.0/pos_payment_terminal/static/description/pos_payment_method_form.png
...
`feedback <https://github.com/OCA/pos/issues/new?body=module:%20pos_payment_terminal%0Aversion:%2018.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/pos <https://github.com/OCA/pos/tree/18.0/pos_payment_terminal>`_ project on GitHub.
